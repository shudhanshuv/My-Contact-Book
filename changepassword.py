...
class ChangePasswordFrame(Frame):
    def __init__(self, parent):
        ...
        self.old_password_entry = Entry(self, font = (NONE, 15), width=15)
        ...
        self.new_password_entry = Entry(self, font = (NONE, 15), width=15)
        ...
        self.confirm_password_entry = Entry(self, font = (NONE, 15), width=15)
    ...
    def change_password_button_click(self):
        query = """select * from Login where Password = '{0}'
        ...
        if row is not None:
            ...
            if new_password == confirm_password:
                query = """update Login set Password = '{0}'
                where Password = '{1}'
                """.format(
